...
const archivedCourses = Array.from({ length: 6 }, (_, index) => ({
  ...
  title: index % 2 === 0 ? 'Web Systems and Technologies 2' : 'Introduction to Computing',
    ...
    <div className="enrolled-dashboard striped-dashboard">
      <aside className="enrolled-sidebar">
        ...
        <nav className="side-nav" aria-label="Student navigation">
          ...
          <Link to="/student/archived-courses" className="side-nav-item plain-nav-item active">
            <Icon name="archive" />
      ...
      <main className="enrolled-main archived-main">
        <header className="enrolled-topbar transparent-topbar">
          <label className="search-input">
            <input type="search" placeholder="Search archived course" />
        ...
        <div className="archive-notice" role="status">
          Course has been archived by your teacher. You can't add or edit anything.
        </div>

        <section className="public-courses-grid archived-courses-grid" aria-label="Archived courses">
          {archivedCourses.map((course) => (
            <article key={course.id} className="course-folder archived-course-folder">
              ...
              <div className="course-card-footer">
                ...
                <button type="button" className="archived-view-button" disabled>
                  View only
                </button>
              </div>
            </article>
