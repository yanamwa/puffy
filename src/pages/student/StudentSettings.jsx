...
export default function StudentSettings() {
  ...
  const savedStudentAccount =
    getStudentAccount(savedUser);
  ...
  const [
    ...
    resolveProfileImage(
      savedStudentAccount.profileImage,
    ),
  );
        ...
        >
          ...
          <aside className="password-security-note">
            ...
            <div>
              ...
              <p>
                After changing your
                password, avoid sharing it
                and sign out from devices
                you no longer use.
              </p>
            </div>
          </aside>
